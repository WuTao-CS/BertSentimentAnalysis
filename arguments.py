...
parser.add_argument('--num_eps', type=int, default=20, help='Number of training epochs.')
parser.add_argument('--num_threads', type=int, default=1, help='Number of threads for collecting the datasets.')
parser.add_argument('--output_dir', type=str, default='bert_bilstm_model', help='Where to save the trained model, if relevant.')
parser.add_argument(
	'--model_name_or_path', 
	type=str, 
	default=None, 
